export const CONFIG = {
  TEMPLATE: {
    ...
    "collection_address": "0xec675B7C5471c67E9B203c6D1C604df28A89FB7f",

    // 2. Set your blockchain chain ID where your NFT collection contract address is deployed (see below for value options)
    "block_chain_id": "43114",

    // 3. Set the default title of your dashboard. If found, this template uses the NFT Collection name for the title.
    "title": "Snail Trail NFT Collection",

    // 4. (Optional) Display the floor price chart
    "timeseries_chart": true,

    // 5. (Optional) Set your banner image
    "banner_picture": "https://www.snailtrail.art/assets/img/logo.svg",
  },
